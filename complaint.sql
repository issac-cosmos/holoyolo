...
(26, 27, 1, '주문취소', '주문을 취소하고 싶은데 어떻게 하나요?', '주문 취소는 발송 전까지 가능합니다.'),
(28, 29, 14, '상품문의', '이 상품은 언제 재입고 되나요?', '재입고 일정은 홈페이지에서 확인 가능합니다.'),
(29, 30, 2, '상품문의', '상품의 가격이 변경될 예정인가요?', '상품 가격은 변경될 수 있습니다.'),
(30, 28, 25, '주문취소', '취소할 수 있는 상품이 무엇인가요?', '취소는 발송 전까지 가능합니다.');
